...
def main():
    ...
    tables=['GA4 Site','GA4 Channels','GA4 AI Traffic','GA4 Landing Pages','GA4 Events','GSC Site','GSC Pages','GSC Queries','SF Pages','SF Hreflang Issues','GA4 Business Events','AI Traffic Sources','Comparisons','Sitemap URLs','Technical Checks','URL Inspection','Manual Results']
    result={}
    for name in tables:
