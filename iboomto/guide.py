...
DESCRIPTIONS={
 ...
 'GSC Queries':('主要数据','每语言/日期或周期最多5000个候选词，合并点击Top100、曝光Top100、新出现候选Top50和增长候选Top50，去重最多300词。selection_reason可筛选多重入选原因。新出现指比较候选池未返回，不保证首次出现。历史不足不判断新词/增长；匿名词及API限制仍存在。'),
